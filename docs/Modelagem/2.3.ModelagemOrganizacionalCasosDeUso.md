...
<div style="width: 1000px; height: 500px; margin: 10px; position: relative;"><iframe allowfullscreen frameborder="0" style="width:1000px; height:500px" src="https://lucid.app/documents/embedded/e898bf49-aec3-48dd-b4c3-5370546a28f8" id="E5de5N-5ps1_"></iframe></div>
...
Model (Modelo)
O Model representa a lógica de negócios, os dados e as regras da aplicação. É responsável por acessar e manipular os dados, seja por meio de um banco de dados, arquivos ou armazenamento em memória. Ele é independente da interface do usuário, o que significa que não depende de como os dados são apresentados ou inseridos. Sua principal função é gerenciar o estado da aplicação, validar os dados e aplicar as regras de negócio.
...
| 1.3    | 09/05/2025 | Adição de introdução ao diagrama de pacotes | [Cristiano Morais](https://github.com/CristianoMoraiss), [Mauricio Ferreira](http://github.com/mauricio-araujoo) |[Ana Catarina](https://github.com/an4catarina), [Victor Hugo](https://github.com/ViictorHugoo) | Verificação antes da entrega |
